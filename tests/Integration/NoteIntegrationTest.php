...
namespace OCA\ZentyalAuthBackend\Tests\Integration\Controller;

use OCP\AppFramework\App;
use OCP\IRequest;
use PHPUnit\Framework\TestCase;

use OCA\ZentyalAuthBackend\Db\Note;
use OCA\ZentyalAuthBackend\Db\NoteMapper;
use OCA\ZentyalAuthBackend\Controller\NoteController;
...
class NoteIntegrationTest extends TestCase {
	...
	public function setUp(): void {
		$app = new App('zentyalauthbackend');
